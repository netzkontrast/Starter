# How To: Detect Csharp From Property Syntax
...
Workflow: Test C# detection from property syntax
...
### Step 1: 'Test C# detection from property syntax'

```python
'Test C# detection from property syntax'
```

### Step 2: Assign html = '<code>public string Name { get; set; }</code>'
...
*Source: test_scraper_features.py:204 | Complexity: Intermediate | Last updated: 2026-03-29*