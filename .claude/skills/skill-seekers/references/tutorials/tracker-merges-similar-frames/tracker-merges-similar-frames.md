# How To: Tracker Merges Similar Frames
...
Workflow: test tracker merges similar frames
...
### Step 1: Assign tracker = TextBlockTracker(...)

```python
tracker = TextBlockTracker()
```

### Step 2: Assign text1 = "def hello():\n    return 'world'"

```python
text1 = "def hello():\n    return 'world'"
```

### Step 3: Assign text2 = "def hello():\n    return 'world!'"

```python
text2 = "def hello():\n    return 'world!'"
```

### Step 4: Call tracker.update()

```python
tracker.update(0, 1.0, text1, 0.8, FrameType.CODE_EDITOR)
```

### Step 5: Call tracker.update()

```python
tracker.update(1, 2.0, text2, 0.9, FrameType.CODE_EDITOR)
```

### Step 6: Assign blocks = tracker.finalize(...)
...
*Source: test_video_scraper.py:1226 | Complexity: Advanced | Last updated: 2026-03-29*